...
checkpoint_path = os.path.join(
    CHECKPOINT_DIR,
    "mobilenetv2_epoch_{epoch:02d}.keras"
)

best_model_path = os.path.join(
    MODEL_DIR,
    "mobilenetv2_fish_disease_best.keras"
)
...
final_model_path = os.path.join(
    MODEL_DIR,
    "mobilenetv2_fish_disease.keras"
)
...
print("\n================================")
print("MOBILENETV2 OVERALL RESULTS")
print("================================")
...
print("\n================================")
print("MOBILENETV2 EXPERIMENT COMPLETED")
print("================================")
