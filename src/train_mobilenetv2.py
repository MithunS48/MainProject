...
RESULTS_DIR = PROJECT_ROOT / "results" / "MobileNetV2"
...
print("=" * 70)
print("MobileNetV2 INDIVIDUAL CNN EXPERIMENT")
print("=" * 70)
...
# (applied only during training for extra regularization)
# ============================================================
...
# Freeze base — only train the head first
...
# MobileNetV2 official preprocessing: [-1, 1]
...
best_model_path = MODEL_DIR / "mobilenetv2_best.keras"
...
# Unfreeze only the top 30 layers of MobileNetV2
...
final_model_path = MODEL_DIR / "mobilenetv2_final.keras"
